...
_C.MODEL.Feature_Generation_MODEL = ""
_C.MODEL.Classifier_Finetuning = False
_C.MODEL.Feats_resampling = False
_C.MODEL.Rels_each_class = 5000
_C.MODEL.max_bg_feats = 0
# -----------------------------------------------------------------------------
# INPUT
# -----------------------------------------------------------------------------
_C.INPUT = CN()
...
_C.DATASETS.debug_num_im = -1
_C.DATASETS.debug_num_val_im = 5000
...
_C.MODEL.num_center_head_cls = 12
_C.MODEL.num_beta = 0.99995
_C.MODEL.cut_rels = 200
_C.MODEL.semantic_embed_dim = 300
_C.MODEL.reweight_fineloss = False
_C.MODEL.ct_loss = False
_C.MODEL.w_ct = 0.0001
_C.MODEL.refine_layers = 2
_C.MODEL.Feature_Generation_Mode = False
_C.MODEL.refine_mask_rate = 0.0
_C.MODEL.PENET_wt = False
_C.MODEL.ft_with_dist0 = False

_C.MODEL.BG_GATE = CN()
_C.MODEL.BG_GATE.ENABLED = False
_C.MODEL.BG_GATE.HIDDEN_DIM = 64
_C.MODEL.BG_GATE.LOSS_WEIGHT = 0.1
_C.MODEL.BG_GATE.INFER_THRES = 0.5
_C.MODEL.BG_GATE.MARGIN = 0.0
_C.MODEL.BG_GATE.DETACH_COARSE = True
_C.MODEL.BG_GATE.APPLY_TO_HTCL_ONLY = True

_C.MODEL.CONFLICT_REENTRY = CN()
_C.MODEL.CONFLICT_REENTRY.ENABLED = False
_C.MODEL.CONFLICT_REENTRY.GROUPS_JSON = ""
_C.MODEL.CONFLICT_REENTRY.REL_PROJ_DIM = 64
_C.MODEL.CONFLICT_REENTRY.REL_HIDDEN_DIM = 256
_C.MODEL.CONFLICT_REENTRY.STAT_CLASS_EMBED_DIM = 8
_C.MODEL.CONFLICT_REENTRY.MLP_HIDDEN_DIM = 128
_C.MODEL.CONFLICT_REENTRY.MLP_LOSS_WEIGHT = 0.2
_C.MODEL.CONFLICT_REENTRY.DISTILL_LOSS_WEIGHT = 0.05
_C.MODEL.CONFLICT_REENTRY.DISTILL_TEMPERATURE = 1.0
_C.MODEL.CONFLICT_REENTRY.PRIOR_TEMPERATURE = 1.0
_C.MODEL.CONFLICT_REENTRY.RECALL_THRESHOLD = 0.5
_C.MODEL.CONFLICT_REENTRY.LAMBDA_BASE = 0.5
_C.MODEL.CONFLICT_REENTRY.LAMBDA_INIT = ()
_C.MODEL.CONFLICT_REENTRY.LAMBDA_LEARNABLE = True
_C.MODEL.CONFLICT_REENTRY.ALPHA_BASE = 0.25
_C.MODEL.CONFLICT_REENTRY.ALPHA_INIT = ()
_C.MODEL.CONFLICT_REENTRY.ALPHA_LEARNABLE = True
_C.MODEL.CONFLICT_REENTRY.BG_SUPPRESS_BETA = 0.1
_C.MODEL.CONFLICT_REENTRY.TRAIN_USE_BG_RECALLED_ONLY = True

_C.TENSORBOARD = CN()
_C.TENSORBOARD.ENABLED = True
_C.TENSORBOARD.LOG_DIR = "/root/tf-logs"
...
_C.MODEL.ROI_RELATION_HEAD.LAST_FEATS_DIM = 1024
_C.MODEL.ROI_RELATION_HEAD.Middle_FEATS_DIM = 1024
...
_C.SOLVER.Classifier_batch = 64
_C.SOLVER.Classifier_max_iter = 100000
_C.SOLVER.Classifier_checkpoint_period = 20000
_C.SOLVER.BASE_LR_ft = 0.000001
_C.SOLVER.cls_ft_STEPS = (60000,)
...
_C.TEST.Save_eval_results = True
_C.TEST.COCO_mAp = True
_C.TEST.Eval_all_metrics = True
_C.TEST.Val_mode = 'Recall'
