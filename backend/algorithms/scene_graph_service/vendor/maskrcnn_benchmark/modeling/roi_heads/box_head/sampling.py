...
class FastRCNNSampling(object):
    ...
    def match_targets_to_proposals(self, proposal, target):
        ...
        # Detector pretraining only needs labels unless the attribute head is enabled.
        fields = ["labels", "attributes"] if self.attribute_on else ["labels"]
        target = target.copy_with_fields(fields)
    ...
    def subsample(self, proposals, targets):
        ...
        for labels_per_image, attributes_per_image, regression_targets_per_image, matched_idxs_per_image, proposals_per_image in zip(
            ...
            if self.attribute_on and attributes_per_image is not None:
